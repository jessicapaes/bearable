...
if st.session_state.demo_mode:
    ...
    <div style="position: fixed; top: 0; left: 0; right: 0; z-index: 999;
        ...
        <a href="?" class="header-link" style="display: flex; align-items: center; gap: 12px; text-decoration: none; cursor: pointer;" onclick="window.location.reload(); return false;">
