...
if not st.session_state.authenticated and not st.session_state.demo_mode:
    ...
    with col2:
        ...
        if not st.session_state.show_signup and not st.session_state.show_password_reset:
...
with col2:
    ...
    if st.session_state.authenticated:
        ...
        # Show login button if not authenticated - scroll to login form
        if st.button("🔐 Login", key="login_header", type="secondary", use_container_width=True):
            # Just reload to scroll to top where login form is
            st.rerun()
...
with tab1:
    ...
    if not display_df.empty:
            ...
            if len(therapies_started) > 0:
                ...
                for therapy in therapies_started:
                    ...
                    if therapy_effect and therapy_effect.get('ready'):
                        ...
                        sig_color = "#10b981" if therapy_effect['significant'] else "#f59e0b"
                        ...
                        <div style="background: linear-gradient(135deg, #ffffff 0%, #f8fafc 100%);
                            ...
                            <div style="background: linear-gradient(135deg, #f1f5f9 0%, #e2e8f0 100%);
                                ...
                                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr));
                                    ...
                                    <div>
                                        <strong style="color: #ef4444; font-weight: 700;">📈 Before:</strong>
                                        <span style="font-weight: 600;"> {therapy_effect['before_mean']:.1f}/10 avg pain</span>
                                    </div>
                                    <div>
                                        <strong style="color: #10b981; font-weight: 700;">📉 After:</strong>
        ...
        if not insights:
            st.info("📊 Keep logging for at least 7 days to see personalized insights!")
